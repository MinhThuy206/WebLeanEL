...
public class ForgotService {
    ...
    public String forgotPass(String email) {
        Optional<User> userOptional = Optional.ofNullable(forgotRepository.findByEmail(email));
    ...
    public String resetPass(String token, String password) {
        Optional<User> userOptional = Optional.ofNullable(forgotRepository.findByToken(token));
